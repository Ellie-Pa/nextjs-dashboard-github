...
// import { fetchCardData } from '@/app/lib/data'; // 删除 fetchRevenue，fetchLatestInvoices，fetchCardData
...
export default async function Page() {
  // const revenue = await fetchRevenue();//删除此行
  // const latestInvoices = await fetchLatestInvoices();//删除此行
  // const {
  //   numberOfInvoices,
  //   numberOfCustomers,
  //   totalPaidInvoices,
